...
const FullPageChat: React.FC = () => {
    const [selectedMode, setSelectedMode] = useState<"text" | "avatar" | null>(null);
                        ...
                        <div className="h-full flex flex-col items-center justify-center gap-8">
                            ...
                            <div className="flex gap-8">
                                ...
                                >
                                    ...
                                    <span className="text-lg font-medium text-gray-700">Text Chat</span>
                                </button>
                                <button
                                ...
                                >
                                    ...
                                    <span className="text-lg font-medium text-gray-700">Video & Voice</span>
                                </button>
                            </div>
                        </div>
                    ) : (
                            ...
                            <div className="flex-1 overflow-y-auto space-y-6">
                                {messages.map((msg, index) => (
                                    <div key={index} className={`flex ${msg.isUser ? "justify-end" : "justify-start"}`}>
                                        <div
                                            className={`max-w-[80%] p-4 rounded-lg ${msg.isUser ? "bg-indigo-600 text-white" : "bg-gray-200 text-gray-800"}`}
                                        >
                                            {msg.text}
                                        </div>
                                    </div>
